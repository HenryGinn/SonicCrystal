...
def get_time_per_sweep():
    if include_demods:
        return 4 + points_per_batch/33 + 1/(4 max_bandwidth**2) (1 - 2*points_per_batch) + 32/max_bandwidth*(points_per_batch/19 - 1/45)
    else:
