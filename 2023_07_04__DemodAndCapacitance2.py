...
base_path = ("D:\\Documents\\Experiments Data\\SonicCrystal\\"
             "Raw Data\\2023_07_04__DemodAndCapacitance2")
...
daq.setDouble('/dev6641/imps/0/output/amplitude', 10) # Set drive voltage
daq.setDouble('/dev6641/imps/0/bias/value', 0) # Set bias voltage

# Frequency settings
#sweeper.set('samplecount', 11)
sweeper.set('samplecount', 4001) # The number of points in a sweep

# Sweeper bandwidth and other settings
sweeper.set('maxbandwidth', 5)
...
for voltage in [10]:# IF YOU WANT TO DO MULTIPLE TRIALS, UNCOMMENT THIS BIT AND INDENT THE FOR LOOP
    daq.setDouble('/dev6641/imps/0/output/amplitude', voltage)
    for sweep_number in range(1, 80):
