...
base_path = "D:\\Documents\\Experiments Data\\SonicCrystal\\2023_06_29__BackgroundFrequencySweep"
...
# Frequency settings
sweeper.set('samplecount', 15001) # The number of points in a sweep
...
for sweep_number in range(5, 40):
    ...
    print(f"Sweep number: {sweep_number:03d}, {sweep_time}, ({start_frequency}, {stop_frequency})")
